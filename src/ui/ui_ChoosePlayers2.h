/********************************************************************************
** Form generated from reading UI file 'ChoosePlayers2.ui'
**
...
#ifndef UI_CHOOSEPLAYERS2_H
#define UI_CHOOSEPLAYERS2_H
...
public:
    ...
    void setupUi(QWidget *Player2_Chooser)
    {
        if (Player2_Chooser->objectName().isEmpty())
            Player2_Chooser->setObjectName("Player2_Chooser");
        Player2_Chooser->resize(800, 600);
        Bg = new QLabel(Player2_Chooser);
        Bg->setObjectName("Bg");
        Bg->setGeometry(QRect(0, 0, 800, 600));
        Bg->setPixmap(QPixmap(QString::fromUtf8(":/Items/titlescreen_new.jpg")));
        ChooserBg = new QLabel(Player2_Chooser);
        ...
        Title = new QLabel(Player2_Chooser);
        ...
        gridLayoutWidget = new QWidget(Player2_Chooser);
...
"}"));
        ...
        retranslateUi(Player2_Chooser);

        QMetaObject::connectSlotsByName(Player2_Chooser);
    } // setupUi

    void retranslateUi(QWidget *Player2_Chooser)
    {
        Player2_Chooser->setWindowTitle(QCoreApplication::translate("Player2_Chooser", "Form", nullptr));
        Bg->setText(QString());
        ChooserBg->setText(QString());
        Title->setText(QCoreApplication::translate("Player2_Chooser", "Choose Initiate Player2", nullptr));
        ChooseButton_SnowPea->setText(QString());
        Img_SnowPea->setText(QString());
        SnowPea_Chosen->setText(QString());
        BackButton->setText(QCoreApplication::translate("Player2_Chooser", "Back", nullptr));
        ChooseButton_PeaShootSingle->setText(QString());
        Img_PeaShooterSingle->setText(QString());
        PeaShooterSingle_Chosen->setText(QString());
        NextBotton->setText(QCoreApplication::translate("Player2_Chooser", "Next", nullptr));
...
namespace Ui {
    class Player2_Chooser: public Ui_Player2_Chooser {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_CHOOSEPLAYERS2_H
